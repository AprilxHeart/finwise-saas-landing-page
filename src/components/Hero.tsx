            ...
            <div className="text-center max-w-7xl mx-auto">
                <div className="mb-8">
                    <span className="inline-block bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-6">
                        🏆 ได้รับความไว้วางใจมากกว่า 1000+ องค์กร
                    </span>
                </div>
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center gap-6 w-fit mx-auto">
                    ...
                    <Link 
                        href="#cta" 
                        className="bg-white hover:bg-gray-100 text-primary border-2 border-primary font-semibold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-2xl text-base min-w-[200px] flex items-center justify-center gap-3"
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 opacity-70">
                    ...
                    <div className="text-center">
                        ...
                        <div className="text-sm text-gray-600">บริการหลังการขาย</div>
                    </div>
                    <div className="text-center">
