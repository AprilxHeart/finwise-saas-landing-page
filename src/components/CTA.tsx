            ...
            <div className="relative mx-auto py-20 px-6">
                <div className="h-full w-full">
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-white text-center max-w-4xl mx-auto">
                        ...
                        <p className="mx-auto max-w-2xl text-gray-200 text-lg lg:text-xl leading-relaxed mb-10">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6">
                            ...
                            <a 
                                ...
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="bg-white hover:bg-gray-100 text-gray-900 font-semibold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-2xl text-base min-w-[200px] flex items-center justify-center gap-3"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* เพิ่มข้อมูลติดต่อ */}
                        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-gray-300">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <span className="text-sm">info@eifel-pump.com</span>
                            </div>
                            <div className="flex flex-col items-center">
                                <svg className="w-6 h-6 mb-2 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span className="text-sm">จันทร์-ศุกร์ 8:00-17:00</span>
                            </div>
                        </div>
                    </div>
                </div>
